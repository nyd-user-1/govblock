...
- **Every state has a front end and a measured number.** Federal 99.5%, New York 99.4% on bills and 96% on statutes, California 97%, New Jersey 97%, Pennsylvania 95%, Texas 95%, Ohio 99.6%, Minnesota 100%, Arizona 99.5%, Maryland 99.8%, Hawaii 99.9%. The Compiler page (`/workspace/dashboard/compiler`) is the grid; `sources.md` is the table.
