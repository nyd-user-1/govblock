...
// The home page sits in the docs shell — the rail on the left, the page's
// own rail on the right (Brendan, 2026-09-07: "all of this fits neatly onto
// the /docs page design"). The sidebar draws the account rail here.
