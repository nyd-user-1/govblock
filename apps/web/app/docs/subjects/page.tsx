...
import { SubjectsBrowser, SubjectsToc } from "@/components/subjects/subjects-browser"
import { Button } from "@govblock/ui/components/ny4/button"

// The subjects doc, on the same header as /docs/bills and /docs/committees:
// title, Copy Page, prev/next, description. congress.gov's "find bills by
// subject" help, its policy-area browse and its legislative-subject browse,
// as one page (Brendan, 2026-09-05). The body reads in the jurisdiction in
// scope, in the browser, so this shell is shared by every visitor.
const title = "Subjects"
const description = "How a bill is filed: the policy area it sits in, the subjects it touches, and every bill under each."
