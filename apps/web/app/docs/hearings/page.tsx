...
// The hearings doc, on the same header as /docs/committees: title, Copy Page,
// prev/next, description, then the newest hearings with their transcripts.
// Congress only: no state publishes its hearings as a record we can hold.
const title = "Hearings"
const previous = { name: "Committees", url: "/docs/committees" }
const next = { name: "Nominations", url: "/docs/nominations" }
            ...
            <div className="flex items-center justify-between md:items-start">
              ...
              <div className="docs-nav flex items-center gap-2">
                <div className="hidden sm:block">
                  <DocsCopyPage page={`# ${title}\n\n${description}`} url="https://gov.nysgpt.com/docs/hearings" />
                </div>
