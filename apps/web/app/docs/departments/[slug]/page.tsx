            ...
            action={
              <>
                ...
                {neighbours.previous ? (
                  ...
                  <Button variant="secondary" size="icon" className={arrow} asChild>
                    <Link href={`/docs/departments?state=${state}`}>
                      <IconArrowLeft />
                ...
                {neighbours.next ? (
                  <Button variant="secondary" size="icon" className={arrow} asChild>
                    <Link href={`/docs/departments/${neighbours.next.slug}`} title={neighbours.next.name}>
                      <IconArrowRight />
            ...
            <div className="hidden h-16 w-full items-center gap-2 px-4 sm:flex sm:px-0">
              {neighbours.previous && (
                <Button variant="secondary" size="sm" className="shadow-none" asChild>
                  <Link href={`/docs/departments/${neighbours.previous.slug}`}>
              ...
              {neighbours.next && (
                <Button variant="secondary" size="sm" className="ml-auto shadow-none" asChild>
                  <Link href={`/docs/departments/${neighbours.next.slug}`}>
