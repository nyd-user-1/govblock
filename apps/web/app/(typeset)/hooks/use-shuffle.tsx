...
import { useLocks } from "@/app/(typeset)/hooks/use-locks"
...
export function useShuffle() {
  ...
  // Clears the type design back to its defaults; the bill in the rail stays.
  const reset = React.useCallback(() => {
    setParams(
      { body: null, heading: null, mono: null, scale: null, measure: null, flow: null, leading: null },
      { history: "replace" }
    )
  }, [setParams])
