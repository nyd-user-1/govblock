...
// Wider than the docs column the other pages keep, since three boards will not
// sit side by side in 640px; the rails are the same sheets. Mocked in
// lib/users/mock.ts until the numbers are counted.
...
export default function UsersPage() {
  return (
    <div data-slot="docs" className="flex items-stretch pb-8 xl:w-full">
      <div className="flex min-w-0 flex-1 flex-col">
        <div className="h-(--top-spacing) shrink-0" />
        <div className="mx-auto flex w-full max-w-7xl min-w-0 flex-1 flex-col gap-6 px-4 py-6 md:px-2 lg:py-8">
