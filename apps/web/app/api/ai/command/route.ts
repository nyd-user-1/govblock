import type {
  ChatMessage,
  ToolName,
} from '@/components/plate/editor/use-chat';
...
import { bedrockModel } from '@/lib/agents/ai-provider';
...
export async function POST(req: NextRequest) {
  ...
  // Every model id the playground names maps onto the two Bedrock tiers:
  // the flash-class ids choose and classify, the rest write.
  const gatewayProvider = (id: string) => bedrockModel(/flash|mini|haiku/i.test(id) ? 'fast' : 'main');
