...
// Ported verbatim from livingston-v3 components/page-header.tsx.
...
function PageHeaderDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p className={cn("max-w-4xl text-base text-balance text-foreground sm:text-lg", className)} {...props} />
  )
}
