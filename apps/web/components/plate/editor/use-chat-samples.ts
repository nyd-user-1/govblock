...
// The template's sample answers for AI commands when /api/ai/command fails,
// split out of use-chat.ts and imported only when one is needed
// (typeset-perf, 2026-09-13): they carry @faker-js/faker, 600 KB of
// development JavaScript, onto every page with an editor.
