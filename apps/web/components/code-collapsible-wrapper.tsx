...
export function CodeCollapsibleWrapper({ title, code, icon, action, after, className, children }: { /** To the right of the copy button, as CodeFrame takes it: a favorite star. */ after?: React.ReactNode; title?: string; code: string; /** Just before the copy button, as CodeFrame takes it: a download. */ action?: React.ReactNode; /** In the file icon's place, as CodeFrame takes it: a bill's chamber seal. */ icon?: React.ReactNode; className?: string; children: React.ReactNode }) {
