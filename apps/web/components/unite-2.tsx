...
// The hero is the flag in a padded field. The second screen is the
// conversation itself: We the People's framing with Unite America leading and
// GovBlocks as the technology partner, then the open-primaries survey. Below
// that, what GovBlocks brings, one section per surface, and the premise the
// whole page stands on. Everything under the hero is <UniteBody>, which the
// root page wears under its own hero (Brendan, 2026-09-14).
//
// The scroller: <ParticleScroll> fixed over the viewport with everything
// scrolling inside it, so the sand effect covers the hero and the copy alike
// where the HTML-in-Canvas API is on, and the page is plain HTML in one
// scroller where it is not.
...
/** Everything under the hero: the conversation, the surfaces, the premise. */
export function UniteBody() {
  return (
    <>
