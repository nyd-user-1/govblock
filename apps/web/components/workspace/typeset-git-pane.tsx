...
export function TypesetGitPane({ billId, view, toolbar }: { billId: number; view: GitView; /** Typeset's rich-text toolbar, drawn under the file row (2026-09-14). */ toolbar?: React.ReactNode }) {
