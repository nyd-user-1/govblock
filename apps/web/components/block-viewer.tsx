...
// Ported from livingston-v3 components/block-viewer.tsx; only the import
// aliases, the item types and the analytics call differ.
...
import {
  ToggleGroup,
  ToggleGroupItem,
} from "@govblock/ui/components/ny4/toggle-group"

type BlockViewerContext = {
  item: Omit<Block, "files"> & { files: Omit<BlockFile, "highlightedContent">[] }
  view: "code" | "preview"
...
function BlockViewerToolbar({ styleName }: { styleName: string }) {
...
function BlockViewerView({ styleName }: { styleName: string }) {
