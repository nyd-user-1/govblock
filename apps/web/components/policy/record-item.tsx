...
// a 1 px divider runs between items. The divider was a border on the item until
// 20:30 ET; a straight border under a rounded hover shows the corners, so the
// line belongs to the list and the hover sits 4 px inside it.
//
