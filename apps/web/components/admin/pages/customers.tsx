...
// paceui's Customer Analytics, as the members: the four stats are the
...
export function CustomersPage() {
  ...
  return (
    <div>
      <PageTitle title="Member Analytics" />
      ...
      <BlockOrder page="dashboard/customers" initial={["passage-and-votes-cast", "member-directory-and-committee-load"]}>
