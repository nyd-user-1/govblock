...
const DAY = 86_400
const HOUR = 3_600
const VOLATILE = /^(clip|typeset_documents|xml_jobs|xml_fallouts|watch|reader_|linkedin_|forks|fork_|commits|users|accounts|sessions|verification|agent|mail_|inbox|chat_|comment|pg_|information_schema)/i
