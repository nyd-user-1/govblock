...
export const REPORTS: Report[] = [
  ...
  { slug: "model-bills", href: "/research/model-bills", title: "Copy-and-paste lawmaking", dek: "ALEC's model policies searched for in the text of every state bill GovBlock holds: which were copied, where, and which became law.", data: ["Model bills", "Bill text"], published: "2026-09-18" },
  { slug: "where-bills-die", href: "/research/where-bills-die", title: "Where bills go to die", dek: "Every bill of the 2023 sessions in 49 legislatures: two in three never got a vote, the gatekeeper committees that held them, and how much less often a minority-party bill passes.", data: ["Bills", "Roll calls", "Sponsors", "Election returns"], published: "2026-09-18" },
  { slug: "primary-is-the-election", href: "/research/primary-is-the-election", title: "The primary is the election", dek: "Two in three House seats are settled before November, by primaries a fifth to a third the size of November's electorate; what a top-two primary would change.", data: ["Election returns", "FEC primaries"], published: "2026-09-18" },
  { slug: "paperwork-wall", href: "/research/paperwork-wall", title: "The paperwork wall", dek: "The paper applications for SNAP, Medicaid, heating assistance, child care, cash help and SSI, every version measured: dozens of pages, and almost none can be typed into.", data: ["Forms"], published: "2026-09-18" },
