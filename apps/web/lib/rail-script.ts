...
export const railScript = (defaultClosed: boolean) =>
  `(function(){try{var d=document.documentElement,c=${defaultClosed ? "true" : "false"};["left","right"].forEach(function(s){var v=localStorage.getItem("rail:"+s);if(v==="closed"||(v!=="open"&&c))d.setAttribute("data-rail-"+s,"closed")})}catch(e){}})()`
