// From beui.dev (https://beui.dev/components/blocks/morphing-tabs), added 2026-09-11 for the bill compare page. Imports repointed; otherwise verbatim.
"use client";
...
import { EASE_OUT, SPRING_GLIDE, SPRING_PRESS } from "@govblock/ui/lib/ease";
import { TOUCH_GESTURE_CLASS, capturePointer } from "@govblock/ui/lib/touch";
