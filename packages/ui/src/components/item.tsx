...
const itemVariants = cva(
  "group/item flex w-full flex-wrap items-center rounded-2xl border text-sm transition-colors duration-100 outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 [a]:transition-colors [a]:hover:bg-muted [a]:hover:border-border [button]:transition-colors [button]:hover:bg-muted [button]:hover:border-border",
  {
    variants: {
      variant: {
