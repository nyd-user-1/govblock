...
// The registry's Blocks starts apart and snaps together on hover. Reversed
// here (Brendan, 2026-09-09: "start with the blocks together and on hover the
// top right block animates"): the two sit flush at rest, the L never moves,
// and the small block lifts out to its lucide place and settles back.
const animations = {
  default: {
    path1: {
      initial: {
  ...
  'default-loop': {
    ...
    path2: {
      ...
      animate: {
        x: [-2, 0, -2],
        y: [2, 0, 2],
        d: ['M15 2 H20 A2 2 0 0 1 22 4 V9 A1 1 0 0 1 21 10 H15 A1 1 0 0 1 14 9 V3 A1 1 0 0 1 15 2 Z', 'M15 2 H21 A1 1 0 0 1 22 3 V9 A1 1 0 0 1 21 10 H15 A1 1 0 0 1 14 9 V3 A1 1 0 0 1 15 2 Z', 'M15 2 H20 A2 2 0 0 1 22 4 V9 A1 1 0 0 1 21 10 H15 A1 1 0 0 1 14 9 V3 A1 1 0 0 1 15 2 Z'],
        transition: {
          duration: 0.8,
          ease: 'easeInOut',
        },
