...
// Ported from livingston-v3 apps/v4/styles/base-rhea/ui/message.tsx: one turn
// of a conversation as a row — an optional avatar, then the content — that
// flips to the right for the reader's own turns.
