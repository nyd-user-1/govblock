...
// Ported from livingston-v3 apps/v4/styles/base-rhea/ui/message-scroller.tsx.
// The headless scroller is @shadcn/react's: it follows the newest message
// while the reader is at the bottom, stops following the moment they scroll
// up, and offers a button back down. This file is only the styling.
