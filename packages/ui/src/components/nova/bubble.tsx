...
// Ported from livingston-v3 apps/v4/styles/base-rhea/ui/bubble.tsx, on this
// kit's tokens: the speech bubble a message's text sits in. `ghost` is the
// assistant's — no fill, full width — and `muted` is the reader's.
